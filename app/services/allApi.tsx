...
export const editCompany = async (id: string, data: object) => {
  try {
    const res = await API.put(`/api/master/company/company/company/${id}`, data);
...
export const getAllActiveWarehouse = async () => {
    try {
        const res = await API.get(
            `/api/master/warehouse/list_warehouse/active`
        );
...
export const updateCompanyCustomer = async (id: string, body: object) => {
    try {
        const res = await API.put(
            `/api/master/companycustomer/${id}/update`,
            body
        );
...
export const getCompanyCustomerByRegion = async (regionId: string) => {
    try {
        const res = await API.get(
            `/api/master/companycustomer/region/${regionId}`
        );
...
export const getCompanyCustomerByArea = async (areaId: string) => {
    try {
        const res = await API.get(
            `/api/master/companycustomer/region/${areaId}`
        );
...
export const addCustomerType = async (payload: {
    name: string;
    status: number;
}) => {
    try {
        const res = await API.post(
            "/api/settings/customer-type/create",
            payload
        );
...
export const updateRouteTypeById = async (id: string, payload: object) => {
    try {
        const res = await API.put(
            `/api/settings/route-type/${id}/update`,
            payload
        );
...
export const addCustomerSubCategory = async (
    payload: Record<string, string | number>
) => {
    try {
        const res = await API.post(
...
export const updateCustomerSubCategory = async (
    id: string,
    payload: Record<string, string | number>
) => {
    try {
...
export const updateChannel = async (id: string, payload: object) => {
    try {
        const res = await API.put(
            `/api/settings/outlet-channels/${id}`,
            payload
        );
...
export const updateExpenseType = async (id: string, body: object) => {
    try {
        const res = await API.put(
            `/api/settings/expense_type/${id}/update`,
            body
        );
...
export const updateDiscountType = async (id: string, body: object) => {
    try {
        const res = await API.put(
            `/api/settings/discount_type/${id}/update`,
            body
        );
...
export const deleteDiscountType = async (id: string) => {
    try {
        const res = await API.delete(
            `/api/settings/discount_type/${id}/delete`
        );
...
export const deletePromotionType = async (id: number) => {
    try {
        const res = await API.delete(
            `/api/settings/promotion_type/${id}/delete`
        );
        return res.data;
    } catch (error: unknown) {
        return handleError(error);
